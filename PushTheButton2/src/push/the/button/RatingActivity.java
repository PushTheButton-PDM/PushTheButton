    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        DatiScambiati[] d=new DatiScambiati[1];
	 	...
	 	if(a!=null)
	 	 ...
	 	 ArrayAdapter<String> adapter = new ArrayAdapter<String> (this,R.layout.row,R.id.textView1,arraydata);	//Si crea l'array adapter per "passare" le stringhe alla listview 
